...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['label' => null, 'name' => null, 'required' => false, 'help' => null, 'options' => [], 'selected' => null, 'placeholder' => '— اختر —']));
...
foreach (array_filter((['label' => null, 'name' => null, 'required' => false, 'help' => null, 'options' => [], 'selected' => null, 'placeholder' => '— اختر —']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div>
    ...
    >
        ...
        <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($value); ?>" <?php if((string) old($name, $selected ?? '') === (string) $value): ?> selected <?php endif; ?>><?php echo e($text); ?></option>
...
<?php /**PATH E:\home\Wajhatak_Production_Ready\backend\resources\views\components\admin\select.blade.php ENDPATH**/ ?>