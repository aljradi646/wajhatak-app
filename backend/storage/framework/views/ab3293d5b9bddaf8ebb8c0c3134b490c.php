...
$message = $__bag->first($__errorArgs[0]); ?>
                    <p class="mt-2 text-sm font-semibold text-red-600 dark:text-red-400"><?php echo e($message); ?></p>
                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-between">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a href="<?php echo e(route('password.request')); ?>" class="text-sm font-bold hover:underline" style="color: #0E8A6D;">
                        نسيت كلمة المرور؟
                    </a>
                <?php endif; ?>
            </div>
...
<?php endif; ?>
<?php /**PATH E:\home\Wajhatak_Production_Ready\backend\resources\views\auth\login.blade.php ENDPATH**/ ?>