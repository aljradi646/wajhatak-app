...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.layouts.admin','data' => ['heading' => 'خصائص العقارات','title' => 'خصائص العقارات']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'خصائص العقارات','title' => 'خصائص العقارات']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.input','data' => ['name' => 'search','value' => ''.e($search).'','placeholder' => 'بحث بالاسم أو الرابط...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'search','value' => ''.e($search).'','placeholder' => 'بحث بالاسم أو الرابط...']); ?>
...
<?php endif; ?>
        ...
        <a href="<?php echo e(route('admin.property-features.create')); ?>" class="inline-flex items-center justify-center px-4 py-2 text-sm font-bold text-white rounded-xl hover:shadow-lg" style="background: linear-gradient(135deg, #075E4A, #0E8A6D, #35C39E); box-shadow: 0 4px 12px rgba(14, 138, 109, 0.25);">
            + خاصية جديدة
        </a>
    </div>
...
<?php $component->withAttributes(['padding' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 font-medium text-gray-900"><?php echo e($feature->name_ar); ?></td>
                            <td class="px-4 py-3 text-gray-600"><?php echo e($feature->name_en); ?></td>
                            <td class="px-4 py-3 text-gray-500 text-left" dir="ltr"><?php echo e($feature->slug); ?></td>
                            <td class="px-4 py-3 text-gray-500 text-left" dir="ltr"><?php echo e($feature->icon ?? '—'); ?></td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-2">
                                    <a href="<?php echo e(route('admin.property-features.edit', $feature)); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">تعديل</a>
                                    <form method="POST" action="<?php echo e(route('admin.property-features.destroy', $feature)); ?>" onsubmit="return confirm('حذف الخاصية؟');">
                                        <?php echo csrf_field(); ?>
        ...
        <?php echo $__env->make('admin.partials.pagination', ['paginator' => $features], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH E:\home\Wajhatak_Production_Ready\backend\resources\views\admin\property_features\index.blade.php ENDPATH**/ ?>