...
<html lang="ar" dir="rtl">
    <head>
        ...
        <title><?php echo e(config('app.name', 'وجهتك')); ?></title>
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center px-4 py-10 auth-backdrop">
            <div>
                <a href="/" class="flex flex-col items-center">
                    <div class="relative flex h-24 w-24 items-center justify-center">
                        <img src="<?php echo e(asset('storage/branding/logo.png')); ?>" alt="شعار وجهتك" class="h-24 w-24 rounded-3xl object-contain drop-shadow-xl" />
                    </div>
            ...
            <p class="mt-6 text-xs text-gray-400 dark:text-gray-500">© <?php echo e(date('Y')); ?> وجهتك — لوحة تحكم الإدارة</p>
        </div>
    </body>
</html>
<?php /**PATH E:\home\Wajhatak_Production_Ready\backend\resources\views\layouts\guest.blade.php ENDPATH**/ ?>