...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.layouts.admin','data' => ['heading' => 'تعديل الوكيل','title' => 'تعديل الوكيل']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'تعديل الوكيل','title' => 'تعديل الوكيل']); ?>
    <?php if (isset($component)) { $__componentOriginalad5130b5347ab6ecc017d2f5a278b926 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalad5130b5347ab6ecc017d2f5a278b926 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.card','data' => ['title' => 'تعديل وكيل','description' => ''.e($agent->user->name).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'تعديل وكيل','description' => ''.e($agent->user->name).'']); ?>
        <form method="POST" action="<?php echo e(route('admin.agents.update', $agent)); ?>">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PATCH'); ?>
            <?php echo $__env->make('admin.agents._form', ['mode' => 'edit', 'agent' => $agent, 'users' => $users], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
                <a href="<?php echo e(route('admin.agents.index')); ?>" class="text-sm text-gray-600 hover:text-gray-900">إلغاء</a>
            </div>
        </form>
...
<?php endif; ?>
<?php /**PATH E:\home\Wajhatak_Production_Ready\backend\resources\views\admin\agents\edit.blade.php ENDPATH**/ ?>