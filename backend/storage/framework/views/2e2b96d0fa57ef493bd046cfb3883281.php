...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.layouts.admin','data' => ['heading' => 'عقار جديد','title' => 'عقار جديد']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'عقار جديد','title' => 'عقار جديد']); ?>
    <?php if (isset($component)) { $__componentOriginalad5130b5347ab6ecc017d2f5a278b926 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalad5130b5347ab6ecc017d2f5a278b926 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.card','data' => ['title' => 'إنشاء عقار','description' => 'أضف عقارًا جديدًا إلى المنصة']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'إنشاء عقار','description' => 'أضف عقارًا جديدًا إلى المنصة']); ?>
        <form method="POST" action="<?php echo e(route('admin.properties.store')); ?>">
            <?php echo csrf_field(); ?>
            <?php echo $__env->make('admin.properties._form', ['property' => new \App\Models\Property], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit']); ?>حفظ العقار <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                <a href="<?php echo e(route('admin.properties.index')); ?>" class="text-sm text-gray-600 hover:text-gray-900">إلغاء</a>
            </div>
        </form>
...
<?php endif; ?>
<?php /**PATH E:\home\Wajhatak_Production_Ready\backend\resources\views\admin\properties\create.blade.php ENDPATH**/ ?>