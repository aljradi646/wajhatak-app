...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.layouts.admin','data' => ['heading' => 'أنواع العقارات','title' => 'أنواع العقارات']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'أنواع العقارات','title' => 'أنواع العقارات']); ?>
...
<?php endif; ?>
        ...
        <a href="<?php echo e(route('admin.property-types.create')); ?>" class="inline-flex items-center justify-center px-4 py-2 text-sm font-bold text-white rounded-xl hover:shadow-lg" style="background: linear-gradient(135deg, #075E4A, #0E8A6D, #35C39E); box-shadow: 0 4px 12px rgba(14, 138, 109, 0.25);">
            + نوع عقار
        </a>
    </div>
...
<?php $component->withAttributes(['padding' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 font-medium text-gray-900"><?php echo e($type->name_ar); ?></td>
                            <td class="px-4 py-3 text-gray-600"><?php echo e($type->name_en); ?></td>
                            <td class="px-4 py-3 text-gray-500 text-left" dir="ltr"><?php echo e($type->slug); ?></td>
                            <td class="px-4 py-3 text-gray-600"><?php echo e(number_format($type->properties_count)); ?></td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-2">
                                    <a href="<?php echo e(route('admin.property-types.edit', $type)); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">تعديل</a>
                                    <form method="POST" action="<?php echo e(route('admin.property-types.destroy', $type)); ?>" onsubmit="return confirm('حذف نوع العقار؟');">
                                        <?php echo csrf_field(); ?>
        ...
        <?php echo $__env->make('admin.partials.pagination', ['paginator' => $types], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH E:\home\Wajhatak_Production_Ready\backend\resources\views\admin\property_types\index.blade.php ENDPATH**/ ?>