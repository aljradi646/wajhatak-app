...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.layouts.admin','data' => ['heading' => 'تعديل طلب المعاينة','title' => 'تعديل طلب المعاينة']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'تعديل طلب المعاينة','title' => 'تعديل طلب المعاينة']); ?>
    <?php if (isset($component)) { $__componentOriginalad5130b5347ab6ecc017d2f5a278b926 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalad5130b5347ab6ecc017d2f5a278b926 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.card','data' => ['title' => 'تعديل طلب معاينة','description' => 'طلب '.e($viewingRequest->client?->name ?? '').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'تعديل طلب معاينة','description' => 'طلب '.e($viewingRequest->client?->name ?? '').'']); ?>
        <form method="POST" action="<?php echo e(route('admin.viewing-requests.update', $viewingRequest)); ?>">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PATCH'); ?>
            <?php echo $__env->make('admin.viewing_requests._form', ['viewingRequest' => $viewingRequest], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit']); ?>حفظ التعديلات <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                <a href="<?php echo e(route('admin.viewing-requests.index')); ?>" class="text-sm text-gray-600 hover:text-gray-900">إلغاء</a>
            </div>
        </form>
...
<?php endif; ?>
<?php /**PATH E:\home\Wajhatak_Production_Ready\backend\resources\views\admin\viewing_requests\edit.blade.php ENDPATH**/ ?>